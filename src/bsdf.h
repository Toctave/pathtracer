...
// BSDFSampler : (void* params, Vec3 out, float* pdf) -> Vec3 out
typedef Vec3 (*BSDFSampler)(void*, Sampler*, Vec3, float*);
...
// Samplers
Vec3 uniform_bsdf_sampler(void* params, Sampler* sampler, Vec3 out, float* pdf);
